...
run_test("inline_images", ({override}) => {
    ...
    assert.equal(
        ...
        '<span class="message_inline_image inline-image-wrapper">' +
    ...
    assert.equal(
        postprocess_content(
            '<img class="inline-image" src="https://zulip.%20[Click%20to%20join%20video%20call](https://meeting.example.com/abcd1234)%20example.com/user_uploads/2/ab/abcd1234/image.png">',
        ),
        "",
    );
});
